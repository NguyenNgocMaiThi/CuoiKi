    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                ...
                <li><a href="storedream.html">Dreamcatcher</a></li>
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        ...
                        <a href="storedream.html" class="cta-btn">Mua ngay<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="Contact_us">
                    ...
                    <p>Nếu bạn là một người đam mê các món quà tặng hoặc vật dụng được làm thủ công bằng tay thì chào mừng bạn đến với shop của chúng tôi nơi đây là chỗ bạn có thể thỏa mãn sự sáng tạo của chính mình.</n></br>
...
<div id="map" style="width:800px;height:450px;margin-left: 185px">
